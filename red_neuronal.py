...
cantidadDatosEntrenamiento = [105, 105, 105, 105, 105, 105, 105, 105, 105, 105]
...
model.add(Conv2D(kernel_size=5,strides=1,filters=64,padding="same",activation="relu",name="capa_3"))
model.add(MaxPool2D(pool_size=2,strides=2))
...
#entrenamiento
model.fit(x=imagenes, y=probabilidades, epochs=100,batch_size=60)
